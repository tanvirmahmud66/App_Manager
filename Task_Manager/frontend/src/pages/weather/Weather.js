  ...
  return (
    <div className='h-[95vh]'>
      <div className='p-4 flex items-center justify-end'>
            <img src={WeatherLogo} width={35}  alt='Quiz App'/>
            <h3 className='ms-1 text-2xl'>Weather</h3>
      </div>
      <div className='h-[80%] flex justify-center items-center'>
        <div className='w-[500px] min-h-auto p-4 border border-blue-300 rounded-xl bg-blue-900 text-white'>
